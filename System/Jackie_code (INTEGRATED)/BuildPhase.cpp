...
void BuildPhase::handleAction(Context* c)
{
    ...
    do{
        ...
        if(this->country->getMoney() > 50){
            ...
            cout<<"HIIII "<<this->country->getMoney()<<endl;
...
int BuildPhase :: chooseSoldierRank(){
    int input;
...
int BuildPhase :: chooseVehicleType(){
    int input;
...
int BuildPhase :: buyMoreSoldiers(int secondInput, string type){
...
int BuildPhase :: chooseArmySize(string type){
    int input;
    if(type == "soldier"){
